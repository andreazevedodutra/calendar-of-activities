        ...
        function ($scope, $locale) {
            ...
            this.getLocaleConfig = function (fullCalendarConfig) {
                if (!fullCalendarConfig.lang && !fullCalendarConfig.locale || fullCalendarConfig.useNgLocale) {
                    ...
                    //console.log(dtf.MONTH);
                    //console.log(dtf.SHORTMONTH);
                    //console.log(dtf.DAY);
                    //console.log(dtf.SHORTDAY);
                    return {
                        monthNames : tValues(["Janeiro", "Fevereiro", "Março", "Abril", "Maio", "Junho", "Julho", "Augosto", "Setembro", "Outubro", "Novembro", "Dezembro"]),
                        monthNamesShort : tValues(["Jan", "Feb", "Mar", "Abr", "Mai", "Jun", "Jul", "Ago", "Set", "Out", "Nov", "Dec"]),
                        dayNames : tValues(["Domingo", "Segunda", "Terça", "Quarta", "Quinta", "Sexta", "Sabado"]),
                        dayNamesShort : tValues(["Dom", "Seg", "Ter", "Qua", "Qui", "Sex", "Sab"])
                    };
                }
